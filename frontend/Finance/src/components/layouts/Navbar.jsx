...
export default function Navbar() {
  ...
  // Check if we are on a public page (landing page, login, signup)
  // If so, we might want to show different links or style
    ...
    <header className="absolute inset-x-0 top-0 z-50">
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            {/* You can add conditional logic here for logged in state if needed */}
          <Link
            to="/login"
            className="text-sm font-semibold text-white hover:text-indigo-400"
          >
            ...
            <div className="-my-6 divide-y divide-gray-800">
              ...
              <div className="py-6">
                <Link
                  to="/login"
                  onClick={() => setMobileMenuOpen(false)}
                  className="block rounded-lg px-3 py-2.5 text-base font-semibold text-white hover:bg-gray-800"
                >
                  Log in
                </Link>
              </div>
